    ...
    <div className="space-y-3">
      <div className="relative">
        <textarea
          ...
          aria-label="自然语言指令输入"
          className="w-full resize-none rounded-2xl border border-white/30 glass px-5 py-4 text-sm leading-6 text-slate-800 placeholder:text-slate-400 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:opacity-50"
        />
        <button
          type="button"
          ...
          aria-label="发送指令"
          className="absolute bottom-3 right-3 flex h-10 w-10 items-center justify-center glass-btn glass-btn-indigo p-2 text-indigo-600"
        >
